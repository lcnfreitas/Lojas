    ...
    render() {
        ...
        return (
            <div className="wrapper">
                <h2 className="header">Estoque Global de Produtos Disponíveis:</h2>
                <div id="search">
                    <label htmlFor="search-input">Buscar:</label>
                    <input onChange={(e) => this.handleInputChange(e)} aria-label="Search" autoComplete="on" id="search-input" name="search_input" value={this.state.search_input} placeholder="Pesquisar..." speech="true" type="search" />
                ...
                <div className="inventory_container">
                    <div className="inventory_row_header" key={uuid()}>
                        <h3 className="inventory_col">Nome do Produto</h3>
                        <h3 className="inventory_col">Nome da Loja</h3>
                        <h3 className="inventory_col">Quantidade</h3>
                        <h3 className="inventory_col">Observações</h3>
                    </div>
